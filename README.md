...
**SQL Server خودش HTTP بلد نیست.** نمونه‌های `examples/v3/` از
...
**`sp_OADestroy` را حذف نکنید.** شیء COM داخل پراسس SQL Server می‌ماند و هر
اجرای بی‌آزادسازی حافظه‌ای است که تا ری‌استارت سرویس برنمی‌گردد.
